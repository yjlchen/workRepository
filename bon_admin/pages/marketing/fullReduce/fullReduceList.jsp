...
<script type="text/javascript" src="${basePath}/pages/marketing/fullReduce/fullReduceList.js"></script>
<style>
	.tool_search_div {
		float: right;
...
<body>
	...
	<div class="inner-page-main layui-clear">
		<div class="inner-page-main-container">
			<div>
				<div style="float:left;"><button class="layui-btn layui-btn-normal" id="to_create_fullReduce">新建满减送</button></div>
				<div style="float:right;">
					<form id="queryform" method="post" class="layui-form" action="">
					<input type="hidden" value="0" name="fullReduce_flag" id="fullReduce_flag" />
					<div class="tool_search_div" >
						<input id="full_reduce_name" name="full_reduce_name" type="text"
