...
<script type="text/javascript" src="${basePath}/pages/marketing/coupon/couponList.js"></script>
<style>
	.tool_search_div {
		float: right;
...
<body>
	...
	<div class="inner-page-main layui-clear">
		<div class="inner-page-main-container">
			<div>
				<div style="float:left;"><button class="layui-btn layui-btn-normal" id="to_create_coupon">新建优惠券</button></div>
				<div style="float:right;">
					<form id="queryform" method="post" class="layui-form" action="">
					<!-- 优惠券状态，需要根据各种时间进行判断 -->
					<input type="hidden" value="0" name="coupon_flag" id="coupon_flag" />
					<div class="tool_search_div" >
						<input id="coupon_name" name="name" type="text"
				...
				<table id="group_list" class="layui-table" > 
					...
					<thead id="group_header">
						<tr>
							...
							<th style="text-align:center;">领取限制</th>
							<th style="text-align:center;">有效期</th>
							<th style="text-align:center;">领取人/次</th>
