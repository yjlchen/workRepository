            ...
            <div class="app-design">
                <form class="form-horizontal" novalidate="">
                        ...
                        <div class="controls">
                            <ul class="module-goods-list clearfix" name="goods">
                                <li style="display:none;"> 
                                	...
                                	<a class="close-modal js-delete-goods small hide"  title="删除" onclick="delGrouponCommodity()">&times;</a> 
                                </li>
                                <li>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="groupon_name" value="" placeholder="输入活动名称" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label"><em class="required">*</em>生效时间：</label>
                        <div class="controls">
                            <input type="text" name="groupon_active_stime" value="" id="data3" />
                            <span>至</span>
                            <input type="text" name="groupon_active_etime" value="" id="data4" />
                        </div>
                    </div>
                    <!-- 活动标签 -->
					<div class="control-group select-goods-box">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="attend_person_num" value="2" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls controls-limit">
                            <label> 
                            <input type="checkbox" checked  id="is_limit_buy"/> 
                            <span>开启限购</span> </label>
                            <input name="limit_buy_num" class="w30" type="text" value=""/>
                            <span>件/人</span>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls controls-join-group">
                            <label> <input class="js-join-group-switch" type="checkbox" id="is_open_groupon" checked/> <span>开启凑团</span></label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls controls-auto-group">
                            <label> <input class="js-auto-group-switch" type="checkbox" id="is_open_simulation_team"/> <span>开启模拟成团</span> </label>
                            <p class="autogroup-tip gray"> 
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls controls-auto-group">
                            <label>
                            <input class="js-chief-discount-switch" type="checkbox" checked="" id="is_captain_discount"/> 
                            <span>团长享受优惠价</span>
                            </label>
                            <p class="autogroup-tip gray"> 
