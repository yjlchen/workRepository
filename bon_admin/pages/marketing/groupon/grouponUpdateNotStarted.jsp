                ...
                <form class="form-horizontal" novalidate="">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls controls-join-group">
                            <label> 
                            <input class="js-join-group-switch" type="checkbox" id="is_open_groupon" checked/> 
                            <span>开启凑团</span>
                            </label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls controls-auto-group">
                            <label> 
                            <input class="js-auto-group-switch" type="checkbox" id="is_open_simulation_team"/> 
                            <span>开启模拟成团</span> 
                            </label>
                            <p class="autogroup-tip gray"> 
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls controls-auto-group">
                            <label><input class="js-chief-discount-switch" type="checkbox" checked="" id="is_captain_discount"/> 
                            	<span>团长享受优惠价</span> </label>
                            <p class="autogroup-tip gray"> 
