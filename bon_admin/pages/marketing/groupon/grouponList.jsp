...
<script type="text/javascript" src="${basePath}/pages/marketing/groupon/grouponList.js"></script>
<style>
	.tool_search_div {
		float: right;
...
<body>
	...
	<div class="inner-page-main layui-clear">
		<div class="inner-page-main-container">
			<div>
				<div style="float:left;"><button class="layui-btn layui-btn-normal" id="to_create_groupon">新建拼团活动</button></div>
				<div style="float:right;">
					<form id="queryform" method="post" class="layui-form" action="">
					<input type="hidden" value="0" name="groupon_flag" id="groupon_flag" />
					<div class="tool_search_div" >
						<input id="groupon_name" name="groupon_name" type="text"
