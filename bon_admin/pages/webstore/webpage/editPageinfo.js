...
layui.use(['form','layer'], function(){
		...
		if(id!=null){
			formalUrl = getRootPath()+ '/webstore/pageinfo/updatePageinfo.action';
		...
		//微页面标题颜色选择设置
		$("input[name='back_color']").on("input propertychange",function(){
			var val=$(this).val();
			$("#module").css("background",val);
		});
		//微页面标题背景颜色重置
		$("#bg_reset").on("click",function(){
			$(this).prev().val("#f9f9f9");
			$("#module").css("background","#f9f9f9");
		});
	})
