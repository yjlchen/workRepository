...
//跳转到手机端
function toMobile(){
	var goodName1 = $("#yulanMain").find("#module .custom-search-input").val();
	var url = ''+getRootPath()+'/pages/webstore/webpage/goodsSearch_mobile.jsp?bgcolor='+bgcolor+'&goodName='+goodName1+'';
	location.href = url;
}
</script>
...
<div class="container " style="min-height: 700px;">
        ...
        <div class="headerbar">
            <div class="headerbar-wrap clearfix">
                <div class="headerbar-preview">
                    ...
                    <ul>
                        <li>
                            <a href="javascript:void(0);" class="js-no-follow" onclick="toMobile()">手机版</a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" class="js-no-follow active" >PC版</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="content ">
        <div class="content-body js-page-content" data-template-id="1"  id="yulanMain">
