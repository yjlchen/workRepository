...
<title>微页面编辑页面</title>
	...
	<style>
        ...
        input[type=week]:focus, input[type=number]:focus, input[type=email]:focus, input[type=url]:focus, input[type=tel]:focus, 
        input[type=color]:focus, input[type=search]:focus, textarea:focus {
...
<body>
<div class="inner-page-top layui-clear" style="border-bottom:none;padding-bottom:16px;">
        ...
        <div class="app-init-container">
            <div class="app__content js-app-main"><div class="app-design clearfix">
                <div class="app-preview">
                    <div class="app-entry" id="module" style="position:relative;">
                            ...
                            <form class="form-horizontal"  id="wymForm">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls" style="margin: 0">
                                        ...
                                        <button id="bg_reset" class="btn js-reset-bg" type="button">重置</button>
