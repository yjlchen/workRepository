...
<script type="text/javascript" src="${basePath}/pages/webstore/webpage/yulan_pc.js"></script>
        ...
        <div class="headerbar">
            <div class="headerbar-wrap clearfix">
                <div class="headerbar-preview">
                    ...
                    <ul>
                        <li>
                            <a href="javascript:void(0);" class="js-no-follow" onclick="toPreview(0)">手机版</a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" class="js-no-follow active" onclick="toPreview(1)">PC版</a>
                        </li>
                    </ul>
                </div>
