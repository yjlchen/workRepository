...
<title>商城后台</title>
<script type="text/javascript" src="${basePath}/pages/webstore/mydoc/voice.js"></script>
            ...
            <div style="display: inline-block;width: 80%">
            	<div class="layui-box layui-upload-button" >
            		<form target="layui-upload-iframe" method="post" key="set-mine" enctype="multipart/form-data" action="">
		            	<input type="file" name="file" lay-type="audio" class="layui-upload-file" /><br>
                ...
                <br>
 <!--  语音显示的div -->
                <div id="images" style="outline:none;margin-top: 30px;">
                </div>
...
<!-- 分页信息 -->
                ...
                <div id="empty" style="width: 33%;padding-left: 10px;margin-top: 10px;">
                	<font size="2">暂无数据，可点击左上角“上传音频”按钮添加</font>
                </div>
                            ...
                            <div class="layui-input-inline">
                                ...
                                <div id="popup" class="layui-form">
                                    <span style="margin: 5px 0 5px 20px;display: inline-block">添加分组</span>
                                    	<input type="hidden" value="2" name="group_type" id="group_type" />
