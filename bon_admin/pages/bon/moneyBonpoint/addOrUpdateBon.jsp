...
<script type="text/javascript" src="addOrUpdateBon.js"></script>
<style type="text/css">
	...
	<div class="inner-page-main layui-clear">
		<div class="inner-page-main-container">
			<div style="padding-top: 20px; padding-right: 20px">
				<form id="bonForm" class="layui-form" action="">
			    	<div id="addMissionContent">
				    	<div class="layui-form-item" style="margin-top: -15px;">
				    		<div class="layui-inline" id="select_featured">
					        <label class="layui-form-label" style="width: 165px;">金额数：</label> 
							     <label class="layui-form-label" style="width:100px"  style="display:none">
		          				 	 <input type="number" min="1" id="money_sort" step="1"  name="money_sort" style="width: 60px;">
		          			    </label>
						    </div>
						 </div>
						 <div class="layui-form-item" style="margin-top: -15px;">
				    		<div class="layui-inline" id="select_featured">
   					       <label class="layui-form-label" style="width: 165px;">棒点数：</label> 
				    		    <label class="layui-form-label" style="width: 100px"  style="display:none">
		          				 	 <input type="number" min="1" id="bonpoint_sort" step="1"  name="bonpoint_sort" style="width: 60px;">
		          			    </label>
