...
<script type="text/javascript" src="${basePath}/pages/bon/experience/verifyExperience.js"></script>
</head>
<body>
	<div class="inner-page-top layui-clear" style="margin:0;padding:0;">
	  <div class="layui-tab layui-tab-brief" lay-filter="commodityTab" style="margin:0;">
		  <ul class="layui-tab-title" style="border-bottom:none;margin-bottom:9px;">
		    <li id="tab1" class="layui-this">待审核</li>
		    <li id="tab2">已发布</li>
		    <li id="tab3">驳回</li>
		  </ul>
		</div>      
			...
			<div  class="layui-row">
				<div class="layui-col-xs11">
					<form id="queryform" method="post" class="layui-form" action="">
						...
						<input type="hidden" value="1" name="searchAll" id="searchAll" />
    					...
    					<div class="layui-inline">
						   ...
						   <div class="layui-inline">
    						...
    						<div class="layui-inline">
						     	...
						     	<div class="layui-input-inline">
						       		<input type="text" name="wx_name" lay-verify="" autocomplete="off" class="layui-input">
						     	</div>
						   </div>
						   <div class="layui-inline">
						     ...
						     <div class="layui-input-inline">
						       <input type="text" name="commodity_name" lay-verify="" autocomplete="off" class="layui-input">
						   	 ...
						   	 <a class="layui-btn" style="margin-bottom:15px;margin-right: 30px" id="to_search">搜索</a>
						  </div>
					</form>
				</div>
			</div>
			<div class="tool_item clearfix">
				<table id="experience_list" class="layui-table layui-form" > 
					...
					<thead id="experience_header">
						<tr>
                            <th style="text-align:center;">发布人昵称</th>
