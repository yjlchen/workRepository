...
<body>
	<div class="inner-page-top layui-clear" style="padding: 14px 21px 14px;">
		<span style="font-size: 18px;">资讯审核</span>
	</div>
				    	...
				    	<div class="layui-form-item" style="margin-top: 10px;">
						 ...
						 <div class="layui-form-item" style="margin-top: -15px;"> 
				    		<div class="layui-inline">
			                    ...
			                    <div id="imgDiv" class="controls" style="display:none;width: 100%;height: 50px;margin-left: 165px;margin-top: -4px; border:none;" disabled="disabled">
						 ...
						 <div class="layui-form-item" style="margin-top: 10px;">
					 	 ...
					 	 <div class="layui-form-item" style="margin-top: 10px;">
				    		<div class="layui-inline">
							    <label class="layui-form-label" style="width: 165px;">审核：</label>
							    <div class="layui-input-inline" >
								      <input type="radio" name="status" value="2" title="通过" lay-filter="statusFilter" checked="" style="margin-top:0">
								      <input type="radio" name="status" value="3" title="驳回" lay-filter="statusFilter" style="margin-top:0">
							    </div>
						    </div>
						 </div>
						 
						 <div class="layui-form-item" style="margin-top: 10px;display:none" id="rejectDiv">
				    		<div class="layui-inline">
							    <label class="layui-form-label" style="width: 165px;"><text  style="color:#DD4B3F">*</text>驳回原因：</label>
							    <div class="layui-input-inline" > 
							       <textarea id="reject_reason" name="reject_reason" type="text" class="layui-input" style="width: 500px;height:100px"></textarea>
							    </div>
						    </div>
						 </div>
...
<script type="text/javascript" src="examineInformation.js"></script>
</html>