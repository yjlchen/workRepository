...
<script type="text/javascript" src="${basePath}/pages/bon/video/videoManage.js"></script>
<title>资讯管理</title>
</head>
<body>
		...
		<div class="inner-page-main-container">
			<div style="padding-top: 20px;margin-bottom: 49px">
				<form class="layui-form" action="" id="queryform">
					<div>
	                <input type="hidden" value="0" name="status" id="status" /><!-- 用于控制商品状态 -->
						...
						<div class="layui-inline">
						 ...
						 <div id='addBtn' class="layui-inline">
						     <div class="layui-input-inline layui-input-btn">
