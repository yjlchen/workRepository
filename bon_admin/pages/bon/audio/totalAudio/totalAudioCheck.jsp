...
<script type="text/javascript" src="totalAudioCheck.js"></script>
<style type="text/css">
em.required {
	font-size: 16px;
	color: #f00;
...
<div class="inner-page-top layui-clear" style="padding: 14px 21px 14px;">
	<span style="font-size: 18px;">音频总集审核</span>
</div>
			    	...
			    	<div class="layui-form-item" style="margin-top: 10px;">
					 ...
					 <div class="layui-form-item" style="margin-top: 10px;">
			    		<div class="layui-inline">
						    ...
						    <div class="layui-input-inline" id="check_result">
					              <input type="radio"  name="check_result"  value="1" title="通过" checked="checked">
			      				  <input type="radio"  name="check_result"  value="0" title="驳回" >
						    </div>
					    </div>
					 </div> 
					 <div class="layui-form-item" style="margin-top: 10px;display:none" id="reject_reason">
			    		<div class="layui-inline">
						    ...
						    <div class="layui-input-inline" > 
						       <textarea name="reject_reason" placeholder="请输入驳回原因" maxlength="250"
				 	 ...
				 	 <div class="layui-inline" style="margin-left: 180px;">
					    <div class="layui-input-inline layui-input-btn">
					    	<a class="layui-btn"  id="check">确定</a>
