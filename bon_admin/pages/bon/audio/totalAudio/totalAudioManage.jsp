...
<script type="text/javascript" src="${basePath}/pages/bon/audio/totalAudio/totalAudioManage.js"></script>
<style>
	.tool_search_div {
		float: right;
			...
			<div>
				<div style="float:left;">
					...
					<div class="layui-form-item" style="display: inline-block;">
						<button class="layui-btn" id="to_create_totalAudio" type="button">新建总集</button>
					</div>
					</form>
				</div>
			</div>
