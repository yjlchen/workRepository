				    	...
				    	<div class="layui-form-item" style="">
						 ...
						 <div class="layui-form-item" style="margin-top: 10px;">
				    		<div class="layui-inline">
							    ...
							    <div class="layui-input-inline" id="check_result">
						              <input type="radio"  name="check_result" lay-filter="check_result" value="1" title="通过" checked="checked">
				      				  <input type="radio"  name="check_result" lay-filter="check_result" value="0" title="驳回" >
							    </div>
						    </div>
						 </div> 
						 <div class="layui-form-item" style="margin-top: 10px;display:none" id="reject_reason">
				    		<div class="layui-inline">
							    ...
							    <div class="layui-input-inline" > 
							       <input type="text"  name="reject_reason" id="bohui" maxlength="250" class="layui-input" style="width: 300px;">
							    </div>
						    </div>
						 </div>
					 	 <div class="layui-inline" style="margin-left: 50px;">
						    <div class="layui-input-inline layui-input-btn">
						    	<a class="layui-btn" id="smit" >提交</a>
...
<script type="text/javascript" src="examineAudio.js"></script>
</html>