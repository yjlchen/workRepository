...
<script>
	...
	$("#iframepage").load("eachAudioManage.jsp?status="+tab+"&audio_id="+audio_id+"&ispay="+ispay
		,{'operFlag' : 'add'}
	);
	...
	layui.use([ 'element', "layer","form" ], function() {
		...
		element.on('tab(docDemoTabBrief)', function(data) {
			...
			$("#iframepage").load("eachAudioManage.jsp?status="+index+"&audio_id="+audio_id+"&ispay="+ispay, {
				'operFlag' : 'add'
			});
		});
	});
