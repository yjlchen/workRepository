...
<script type="text/javascript" src="addOrUpdateMission.js"></script>
<style type="text/css">
...
<div class="inner-page-top layui-clear" style="padding: 14px 21px 14px;">
		<span style="font-size: 18px;">每日任务编辑</span>
	</div>
			    	...
			    	<div id="addMissionContent">
						 <div class="layui-form-item" style="margin-top: -15px;">
				    		<div class="layui-inline">
							    <label class="layui-form-label" style="width: 165px;">任务名称：</label>
