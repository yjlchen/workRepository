...
//		parent.document.getElementById(data_pjax).src = getRootPath() + "/pages/bon/experience/addExperience.jsp?backFlag=0"
		location.href = getRootPath() + "/pages/commodity/manage_hongkong/addBatch.jsp?commId="+commId;
	});
	$("#to_return").click(function() {
		location.href = getRootPath() + "/pages/commodity/manage_hongkong/commodityList.jsp";
	});
	$('#seach').click(searchPage)
});
