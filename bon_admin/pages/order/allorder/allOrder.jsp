...
<script type="text/javascript" src="${basePath}/pages/order/allorder/allOrder.js"></script>
<title>所有订单</title>
<style type="text/css">
...
<body>
	<div class="inner-page-top layui-clear" style="padding: 14px 21px 14px;">
	   <span style="font-size: 18px;">所有订单</span>
  	</div>
		...
		<div class="inner-page-main-container">
						...
						<div class="layui-form-item" style="display: inline-block">
							...
							<div class="layui-input-block" style="width: 120px">
								<select lay-filter="test"  id="orderstate" name="order_state">
									...
									<option value="22">下单审核中</option>
									<option value="23">下单失败</option>
			...
			<div class="layui-tab" lay-filter="ordertab">
			  <ul class="layui-tab-title">
			    ...
			    <li lay-id="2">待发货</li>
			    <li lay-id="21">待审核</li>
			    <li lay-id="22">下单审核中</li>
			    <li lay-id="23">下单失败</li>
			    <li lay-id="3">已发货</li>
			    <li lay-id="4">已完成</li>
			    <li lay-id="5">已关闭</li>
			    <li lay-id="6">退款中</li>
